# -*- coding: utf-8 -*-
"""
Created on Fri Sep 22 09:51:48 2023
...
def preprocess_ecg(ecg, sample_rate = 500, leads = "all_leads", new_freq=None, new_len=None, scale=1,
    ...
    if leads == "all_leads":
        leads = all_leads
    elif leads =="reduced_leads":
        leads = reduced_leads
    else:
        raise Exception('leads not recognised. Should be "all_leads" or "reduced_leads.')
    ...
    ecg_reshaped = np.transpose(ecg_reshaped)
